...
function createConsumer(config: any, onData: any) {
...
async function consumerExample() {
  ...
  const consumer = await createConsumer(config, ({ key, value }: any) => {
...
// testing this: npx nodemon consumer.ts getting-started.properties 